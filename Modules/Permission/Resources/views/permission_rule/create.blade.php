            ...
            <form id="my_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="url_path" value="" data-required="false" placeholder="url" readonly="readonly">
    ...
    <script>
        ...
        function confirmCreate()
        {
            try {
                ...
                $.ajax({
                    url: "{{route("permission.permission_rule.store")}}",
                    // traditional: true,
                    method: "post",
                    data: params,
        ...
        //     let pid_node = $('input[name=pid]');
        //     let select_val = $(node).val();
        //     //let type = $(node).find("option:selected").attr("datatype").split(",");
        //     if (select_val.length > 0) {
        //         $(pid_node).val(select_val);
        //     } else {
        //         $(pid_node).val(0);
        //     }
        // }
