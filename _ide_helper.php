 ...
 * Generated for Laravel 7.3.0 on 2020-03-30 02:46:47.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
        ...
        /**
         * Attempt to authenticate using HTTP Basic SsoAuthController.
         *
         * @param string $field
...
namespace App\Services\Sso\Facades {
    ...
    class Sso {
         ...
         * @static
         */
        public static function redirect($request, $user)
        {
                        /** @var \App\Services\Sso\SsoService $instance */
                        return $instance->redirect($request, $user);
        }
...
namespace  {
    ...
    class Sso extends \App\Services\Sso\Facades\Sso {}
